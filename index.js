...
app.post('/webhook/', function (req, res) {
  var info = http.request("http://graph.facebook.com/v2.6/<USER_ID>?fields=first_name,last_name,profile_pic,locale,timezone,gender&access_token=" + process.env.TOKEN, function(data) {
