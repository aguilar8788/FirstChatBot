...
module.exports = {
  ...
  computerWillNotBoot: ["Hmm, well first lets try the basics. Please insure that your computer has power, or if it is a laptop insure your battery is charged.",
                        "Next we should check if there are any lights on. This will indicate that we have power. If you do have power, but no display, it may indicate an issue with your display. Look for a power light on the computer. If you do not have a power indicator you can just ignore this.",
                        "Finally, I want you to hold the power button down for 30 seconds, release the button, then finally try to turn the computer back on. Sometimes computers can go into sleep mode, and may give issues getting the computer to come back on.", "end"],
